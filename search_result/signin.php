    ...
    <div class="mt-32 py-8 bg-white">
        <div class="max-w-lg mx-auto">
            <form class="border border-gray-200 rounded-2xl shadow-sm p-8 space-y-4">
              ...
              <div class="">
                <button class="mt-4 text-white w-full py-2 px-3 rounded-full bg-blue-400 border-none hover:bg-blue-500 cursor-pointer">Sign In</button>
              </div>
              <p class="text-sm text-center text-gray-500">New to Intuitive Paper? <a href="" class="text-blue-400 underline cursor-pointer hover:text-blue-500 focus:outline-none font-medium">Register now</a></p>
            </form>
        </div>
    </div>
</div>
